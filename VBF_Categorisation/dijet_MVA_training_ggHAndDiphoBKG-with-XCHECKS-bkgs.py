...
for i in clfs.keys():
    ...
    plt.title('2016_full_preselection_trained_on_ggh_and_dipho_only_mva_score_plot')
    ...
    plt.savefig('2016_full_preselection_trained_on_ggh_and_dipho_only_mva_score_plot.png', bbox_inches = 'tight')
    plt.show()
...
def plot_rocs(rocs = {}, dump=False, range=[[0,1],[0,1]], label='', title='', rocs_train=None):
    ...
    plt.show()
plot_rocs(rocs_valid, label='2016_ROC_XCHECK1_full_VBF_preselection_trained_on_ggh_and_dipho_tested_on_datadriven', title = 'ROC for all backgrounds')
plot_rocs(rocs_valid_ggh, label='2016_ROC_XCHECK2_full_VBF_preselection_trained_on_ggh_and_dipho_tested_on_datadriven', title = 'ROC for ggh rejection')
plot_rocs(rocs_valid_dipho, label='2016_ROC_XCHECK3_full_VBF_preselection_trained_on_ggh_and_dipho_tested_on_datadriven', title = 'ROC for dipho rejection')
plot_rocs(rocs_valid_QCD, label='2016_ROC_XCHECK4_full_VBF_preselection_trained_on_ggh_and_dipho_tested_on_datadriven', title = 'ROC for QCD rejection')
def compare_train_test(clf,x_train,y_train,w_train,x_test,y_test,w_test, bins=100, label=''):
    ...
    plt.savefig('2016_full_preselection_trained_on_ggh_and_dipho_only_overtrain_xcheck_plot.png')
    plt.show()
for i, c in clfs.items():
    print \
    compare_train_test(c,
                       X_train,Y_train,W_train, 
                       X_valid,Y_valid,W_valid, label='2016_full_preselection_trained_on_ggh_and_dipho_only_overtrain_xcheck_plot')
